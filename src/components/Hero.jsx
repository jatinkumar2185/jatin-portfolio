      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-7xl font-black tracking-tight mb-4 text-[#F8FAFC]"
          >
            Hi, I'm{' '}
          ...
          <div className="flex items-center gap-4 justify-center lg:justify-start">
            ...
            {[
              ...
              <motion.a
                ...
                className="w-10 h-10 rounded-xl flex items-center justify-center border border-[rgba(56,189,248,0.15)] text-[#94A3B8] hover:text-[#38BDF8] transition-all"
              >
                <Icon size={18} />
              </motion.a>
            ))}
        ...
        >
          <div className="relative w-64 h-64 sm:w-80 sm:h-80">
            ...
            {/* Profile Image */}
            <div className="absolute inset-8 rounded-full overflow-hidden border-2 border-[rgba(56,189,248,0.3)]">
              <img
                src={profileImg}
            ...
            <motion.div
              ...
              className="absolute -top-2 -right-2 glass rounded-xl px-3 py-2 text-xs font-mono text-[#38BDF8]"
            >
              AI/ML 🤖
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -bottom-2 -left-2 glass rounded-xl px-3 py-2 text-xs font-mono text-[#A78BFA]"
            >
              Full Stack 💻
            </motion.div>

            {/* Glow */}
            <div className="absolute inset-8 rounded-full blur-2xl bg-gradient-to-br from-[rgba(56,189,248,0.2)] to-[rgba(139,92,246,0.2)] -z-10" />
          </div>
        </motion.div>
      </div>
